    ...
    <Container>
      ...
      {schedules && schedules.length > 0 ? (
        <>
          ...
          <Link to={`/susun`}>
            <AddJadwalButton mobile={isMobile}>
...
const PageTitle = styled.h1`
  margin: ${({ mobile }) => (mobile ? "-40px 0 0 0px" : "0px 48px 12px 48px")};
...
`;
const AddJadwalButton = styled.div`
  margin: ${({ mobile }) => (mobile ? "20px 0 10px" : "0px 48px 20px 48px")};
  display: ${({ mobile }) => (mobile ? "flex" : "static")};
  justify-content: center;
}}
`;
